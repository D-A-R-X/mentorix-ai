...
function initSliders() {
  const sliderMap = [
    { id: "confidence",  badge: "confidenceVal"  },
    { id: "tech",        badge: "techVal"         },
    { id: "core",        badge: "coreVal"         },
    { id: "mgmt",        badge: "mgmtVal"         },
    { id: "proTech",     badge: "proTechVal"      },
    { id: "proMgmt",     badge: "proMgmtVal"      },
    { id: "proCore",     badge: "proCoreVal"      },
    { id: "switchTech",  badge: "switchTechVal"   },
    { id: "switchMgmt",  badge: "switchMgmtVal"   },
    { id: "switchCore",  badge: "switchCoreVal"   },
  ];
...
function parseFormData() {
  ...
  const sv = (id) => parseInt(g(id)?.value) || 3; // slider value with fallback
  ...
  if (status === "student") {
    return {
      ...
      tech_interest:       sv("tech"),
      core_interest:       sv("core"),
      management_interest: sv("mgmt"),
      years_experience:    0,
    };
  }
  ...
  if (status === "working_professional") {
    return {
      ...
      cgpa:                0,
      backlogs:            0,
      tech_interest:       sv("proTech"),
      management_interest: sv("proMgmt"),
      core_interest:       sv("proCore"),
      years_experience:    parseInt(g("experience")?.value) || 0,
  ...
  if (status === "career_switcher") {
    return {
      ...
      cgpa:                7,
      backlogs:            0,
      tech_interest:       sv("switchTech"),
      management_interest: sv("switchMgmt"),
      core_interest:       sv("switchCore"),
...
function validateForm(data) {
  ...
  if (!data.decision_time && data.decision_time !== 0)
    return "Please enter decision time in months.";
  return null;
}
